...
async function configurarRedSocial() {
    ...
    for (const browserType of ['chromium']) {
        ...
        let nombrePrueba = 'ConfigurarRedSocial';
        ...
        for (var i=0; i<arrayUrls.length;i++) {
            ...
            await page.click('.gh-setting-first.gh-setting-last .gh-setting-action .gh-btn');

            await page.fill('[placeholder="https://www.facebook.com/ghost"]', 'https://www.facebook.com/uniandes');
...
(async () => console.log(await configurarRedSocial()))();
